...
{
    if (GetRh() == true && c == true)
    {
        return true;
    }
    if (GetRh() == false && c == false)
    {
        return true;
    }
    if (GetRh() == true && c == false)
    {
        return true;
    }
    if (nm == 'A' || nm == 'O')
...
int main()
{
    ...
    bool hopleRh = true;
    if (!danhSach[cha]->GetRh() && danhSach[me]->GetRh())
    {
        hopleRh = false;
    }
    ...
    {
        cout << "Nhom mau khong hop le voi luat di truyen" << endl;
    }
    cout << "==========================" << endl;
    ...
    cin >> x;
    x--;
    cout << "Nhung nguoi co the nhan mau: " << ten[x] << danhSach[x]->GetTen();
    if (danhSach[x]->GetRh())
    {
        cout << "+" << endl;
    }
